...
3.1.0.2 — 2026-09-26
-----------------
 * Страницы брендов и коллекций магазина (shop/brand, shop/collection) получают self-canonical: добавлены в canUrlEnableDefaultControllers.
 * Sitemap не включает бренды без товаров, видимых в листинге по умолчанию, и фильтры по таким брендам. Видимость считается как в листинге: активные товары сайта без дочерних предложений, с учётом настройки «только в наличии» (склады магазина или магазина и поставщиков). Если определить не удалось, бренды не исключаются.
